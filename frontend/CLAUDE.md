...
## Stack
**Vite 6** · **React 18.3** · TypeScript · **Tailwind 3.4** · **TanStack Query** · React Router · **Recharts** · decimal.js · date-fns · zod. Single-origin; talks to `/api/v1` via `src/lib/api.ts` (axios, `withCredentials`).
